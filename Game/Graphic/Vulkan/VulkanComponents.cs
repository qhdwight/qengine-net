...
internal record struct VkGraphics
{
    ...
    internal Buffer compBufIn;
    internal Buffer compBufOut;
    internal DeviceMemory compBufMemIn;
    internal DeviceMemory compBufMemOut;
    ...
    internal DescriptorPool descPool;
